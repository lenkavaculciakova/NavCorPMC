...
# to compute gradient deviations for DWI b-vector correction
...
# Please note command line arguments in call to gradient_unwarp.py in GradientDistortionUnwarp.sh
FSL ./GradientDistortionUnwarp.sh --workingdir=$OUT_PATH/wd --coeffs=$COEFFS --in=$IN --out=$OUT --owarp=$WARP
